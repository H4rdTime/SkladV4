...
class Worker(SQLModel, table=True):
    ...
    stock_movements: List["StockMovement"] = Relationship(back_populates="worker")
...
class EstimateItem(SQLModel, table=True):
    ...
    product: Product = Relationship() # Односторонняя связь, нам не нужно знать из товара, в каких он сметах
